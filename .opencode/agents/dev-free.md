...
model: opencode-zen/north-mini-code       # 🚀 Reemplaza a minimax-m3
fallback_models:
  - DeepSeek V4 Flash Free         # ⚡ El cerebro rápido de respaldo
...
permission:
  ...
  bash:
    ...
    "*": ask
  task:
    "planner-free": allow          # 🤝 Permitimos invocar automáticamente al subagente planificador
    "qa-engineer-free": allow
    "brainstormer-free": allow
    "documentacion-free": allow
    "uxui-designer-free": allow
---
